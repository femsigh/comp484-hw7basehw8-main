...
- HW6 CheckList 
  ...
  4. External stylesheet: <link rel="stylesheet" href="css/styles.css">  in <head>.
     
  6. Color palette: Five colors documented at top of CSS and applied to header, footer, sections.
...
-> i may of played with it to make it look better on the eyes
  ...
  7. Font sizes: h1: 4em, h2: 2.2em, h3: 1.5em.
  8. Font weights: 700 for headings, 600 for company names & nav links, 400 for body text.
...
- Background image + gradient: .work-section uses linear-gradient(rgba(189,204,155,0.9), ...) overlay and url("../images/bgkhw8.jpg") center/cover no-repeat. (not working yet)
